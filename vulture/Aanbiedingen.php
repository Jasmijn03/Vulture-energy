  ...
  <head>
	...
	<body>
       <header>
        ...
        <main>
            <img class="afbeelding1" src="images/Lemon.png" alt="Huidige aanbieding">
            <img class="afbeelding2" src="images/" alt="Aankomende aanbieding">
            <img class="afbeelding3" src="images/" alt="Aankomende aanbieding">
        </main>
